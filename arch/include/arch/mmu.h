...
#define ARCH_MMU_AT_FLAG_HYP (0x1 << 1) 
#define ARCH_MMU_AT_FLAG_PA  (0x2 << 1)
#define ARCH_MMU_AT_FLAG_IPA (0x3 << 1)
#define ARCH_MMU_AT_FLAG_R   (0x0)
#define ARCH_MMU_AT_FLAG_W   (0x1)
#endif
...
#define ARCH_ASPACE_FLAG_USER           0
