...
#define HSR_CP32_REGS_MASK                                     \
  (HSR_CP32_OP1_MASK | HSR_CP32_OP2_MASK | HSR_CP32_CRN_MASK | \
   HSR_CP32_CRM_MASK)
...
#define HSR_SYSREG_REGS_MASK                                         \
  (HSR_SYSREG_OP0_MASK | HSR_SYSREG_OP1_MASK | HSR_SYSREG_CRN_MASK | \
   HSR_SYSREG_CRM_MASK | HSR_SYSREG_OP2_MASK)
