...
#define CTX_PMCR_EL0		U(0x10)
#define CTX_CPTR_EL3		U(0x18)
#define CTX_ZCR_EL3		U(0x20)
#define CTX_SPSR_EL3		U(0x28)
#define CTX_ELR_EL3		U(0x30)
#define CTX_SP_EL3		U(0x38)
...
#define CTX_GPREG_X18		U(0x0)
#define CTX_GPREG_X19		U(0x8)
#define CTX_GPREG_X20		U(0x10)
#define CTX_GPREG_X21		U(0x18)
#define CTX_GPREG_X22		U(0x20)
#define CTX_GPREG_X23		U(0x28)
#define CTX_GPREG_X24		U(0x30)
#define CTX_GPREG_X25		U(0x38)
#define CTX_GPREG_X26		U(0x40)
#define CTX_GPREG_X27		U(0x48)
#define CTX_GPREG_X28		U(0x50)
#define CTX_GPREG_X29		U(0x58)
#define CTX_GPREG_LR		U(0x60)
#define CTX_GPREG_SP_EL0	U(0x68)

#define CTX_TPIDR_EL0		U(0x0)
#define CTX_TPIDRRO_EL0		U(0x8)
...
#define CTX_FP_CPU		U(0x210)
#if CTX_INCLUDE_AARCH32_REGS
#define CTX_FP_FPEXC32_EL2	U(0x218)
#endif

#define CTX_EXCEPTION_END	U(0x110)

#ifdef WITH_MONITOR_MODE
#define CTX_INCLUDE_EL1_REGS	1 
#define CTX_INCLUDE_EL2_REGS	1
#define CTX_INCLUDE_EL3_REGS	1

#define CTX_GPREGS_OFFSET	U(0x0)
#define CTX_GPREGS_END		U(0x100)

#define CTX_EL3STATE_OFFSET	U(0x0)
#define CTX_EL3STATE_END	U(0x40)
...
#define CTX_FPREGS_OFFSET	(CTX_GPREGS_OFFSET + CTX_GPREGS_END)
#endif

#define CTX_FPREGS_END		U(0x220)
...
#define CTX_INCLUDE_EL1_REGS	1
#define CTX_GPREGS_OFFSET	U(0x0)
#define CTX_GPREGS_END		U(0x70)
#define CTX_EL1_SYSREGS_OFFSET	U(0x0)
#define CTX_EL1_SYSREGS_END	U(0x10)


#define CTX_EL3STATE_OFFSET	U(0x0)
#define CTX_EL3STATE_END	U(0x0)

#define CTX_EL2_SYSREGS_OFFSET	U(0x0)
#define CTX_EL2_SYSREGS_END	U(0x0)
 ...
 * entry and exit.
 */
 /* <c, n> - <el3, el1>, <el2, el1>, <el1, el0(nothing)> */
...
#define get_gpregs_ctx(h)	(&((tcpu_context_t *) h)->gpregs_ctx)

#if CTX_INCLUDE_EL3_REGS
#define get_el3state_ctx(h)	(&((pcpu_context_t *) h)->el3state_ctx)
#endif
#if CTX_INCLUDE_EL1_REGS
#define get_el1_sysregs_ctx(h)	(&((pcpu_context_t *) h)->el1_sysregs_ctx)
#endif
#if CTX_INCLUDE_EL2_REGS
# define get_el2_sysregs_ctx(h)	(&((pcpu_context_t *) h)->el2_sysregs_ctx)
#endif
#if CTX_INCLUDE_FPREGS
# define get_fpregs_ctx(h)	(&((tcpu_context_t *) h)->fpregs_ctx)
#endif
 ...
 */
CASSERT(CTX_GPREGS_OFFSET == __builtin_offsetof(tcpu_context_t, gpregs_ctx), \
	assert_core_context_gp_offset_mismatch);
#if CTX_INCLUDE_EL3_REGS
CASSERT(CTX_EL3STATE_OFFSET == __builtin_offsetof(pcpu_context_t, el3state_ctx), \
	assert_core_context_el3state_offset_mismatch);
#endif	
#if CTX_INCLUDE_EL1_REGS
CASSERT(CTX_EL1_SYSREGS_OFFSET == __builtin_offsetof(pcpu_context_t, el1_sysregs_ctx), \
	assert_core_context_el1_sys_offset_mismatch);
#endif
#if CTX_INCLUDE_EL2_REGS
CASSERT(CTX_EL2_SYSREGS_OFFSET == __builtin_offsetof(pcpu_context_t, el2_sysregs_ctx), \
	assert_core_context_el2_sys_offset_mismatch);
#endif
#if CTX_INCLUDE_FPREGS
CASSERT(CTX_FPREGS_OFFSET == __builtin_offsetof(tcpu_context_t, fpregs_ctx), \
...
#if CTX_INCLUDE_EL3_REGS
void el3_sysregs_context_save(el3_sysregs_t *regs);
void el3_sysregs_context_restore(el3_sysregs_t *regs);
#endif
