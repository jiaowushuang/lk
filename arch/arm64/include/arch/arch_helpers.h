...
DEFINE_RENAME_SYSREG_RW_FUNCS(icc_dir_el1, ICC_DIR_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(icc_sre_el1, ICC_SRE_EL1)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_vtr_el2, ICH_VTR_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_misr_el2, ICH_MISR_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_eisr_el2, ICH_EISR_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(ich_elrsr_el2, ICH_ELRSR_EL2)
