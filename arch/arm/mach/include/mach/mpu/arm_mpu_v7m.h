...
#define REGION_ATTR_TO_PARTITION_ATTR(p, r) ((p)->rasr_attr = (r)->rasr)
...
#define K_MEM_PARTITION_P_RW_U_NA_DEVICE  ((k_mem_partition_attr_t) \
	{ (DEVICE_NON_SHAREABLE | P_RW_U_NA_Msk) })
