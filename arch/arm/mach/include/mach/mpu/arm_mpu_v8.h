...
#include <mach/mpu/arm_mpu_a_r.h>
...
#define MPU_RBAR_BASE_Msk       (0x3FFFFFFUL << MPU_RBAR_BASE_Pos)
...
#define REGION_RAM_TEXT_WIDE_ATTR(limit)					    \
	{								    \
...
#define REGION_ATTR_TO_PARTITION_ATTR(p, r) ((p)->rbar = (r)->rbar);((p)->mair_idx = (r)->mair_idx)
...
#define _ARCH_MEM_PARTITION_ALIGN_CHECK(start, size) \
	DEBUG_ASSERT((size > 0) && ((uint32_t)start % \
