...
ssize_t arm_dcc_read(uint32_t *buf, size_t len, sys_time_t timeout) {
    sys_time_t start = 0;
...
ssize_t arm_dcc_write(const uint32_t *buf, size_t len, sys_time_t timeout) {
    sys_time_t start = 0;
