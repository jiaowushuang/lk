...
static sys_time_t tick_interval_ms;
static sys_bigtime_t tick_interval_us;
...
static void arm_cm_systick_set_periodic(sys_time_t period) {
...
sys_time_t current_time(void) {
    ...
    sys_time_t res = (ticks * tick_interval_ms) + delta;
...
sys_bigtime_t current_time_hires(void) {
    ...
    sys_bigtime_t res = (ticks * tick_interval_us) + delta;
