...
static paddr_t find_rsdp_pc() {
  ...
  auto ac = kern::make_auto_call([bios_ptr]() {
...
static status_t initialize_table(size_t i) {
  ...
  auto cleanup_header_mapping = kern::make_auto_call([header]() {
...
status_t acpi_lite_init(paddr_t rsdp_pa) {
  ...
  auto cleanup_rsdp_mapping = kern::make_auto_call([rsdp_ptr]() {
  ...
  auto cleanup_sdt_mapping = kern::make_auto_call([sdt_ptr]() {
