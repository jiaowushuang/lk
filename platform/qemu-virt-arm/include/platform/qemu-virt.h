...
#define CPUPRIV_SIZE        (0x00050000)
...
#define CRASH_UART_BASE UART_BASE // (PERIPHERAL_BASE_VIRT + 0x09040000)
#define CRASH_UART_CLK_IN_HZ	1
#define CONSOLE_BAUDRATE	115200

/* Cortex-A53 midr for revision 0 */

#define ECTLR_EL1				S3_1_C15_C2_1
#define MERRSR_EL1				S3_1_C15_C2_2
#define L2MERRSR_EL1				S3_1_C15_C2_3
#define CPUACTLR_EL1				S3_1_C15_C2_0

/* interrupts */
#define ARM_GENERIC_MAINTENANCE_INT 25 // PPI6 - VGIC_MAINTENANCE
#define ARM_GENERIC_TIMER_HYPERVISOR_INT 26 // PPI5
#define ARM_GENERIC_TIMER_VIRTUAL_INT 27 // PPI4 - VPPI
#define ARM_GENERIC_TIMER_PHYSICAL_SECURE_INT 29 // PPI1
#define ARM_GENERIC_TIMER_PHYSICAL_INT 30 // PPI2
