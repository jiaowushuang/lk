...
void platform_early_init(void) {
    ...
    arm_generic_timer_init(ARM_GENERIC_TIMER_HYPERVISOR_INT, 0);
    arm_generic_vtimer_init(ARM_GENERIC_TIMER_VIRTUAL_INT, 0);
#else
...
#else
    // novm_add_arena("ram", MEMBASE, MEMSIZE);
#endif
...
u_register_t platform_get_stack_protector_canary(void)
{
#if ENABLE_FEAT_RNG
