...
status_t mutex_acquire_timeout(mutex_t *, sys_time_t); /* try to acquire the mutex with a timeout value */
...
public:
    ...
    status_t acquire(sys_time_t timeout = INFINITE_TIME) { return mutex_acquire_timeout(&lock_, timeout); }
