...
struct timer;
typedef enum handler_return (*timer_callback)(struct timer *, sys_time_t now, void *arg);
...
typedef struct timer {
    ...
    sys_time_t scheduled_time;
    sys_time_t periodic_time;
...
void timer_set_oneshot(timer_t *, sys_time_t delay, timer_callback, void *arg);
void timer_set_periodic(timer_t *, sys_time_t period, timer_callback, void *arg);
